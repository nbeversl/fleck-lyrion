...
class Album extends React.Component {
    ...
    componentDidUpdate() {
        ...
        if (this.props.getFromId) {
            if (this.state.album && this.state.album.id == this.props.getFromId) { return }
               this.props.library.getAlbumFromID(this.props.getFromId, (album) => {
               this.setState({
                   album:album,
               })
                                ...
                                { this.state.discs ?
                                    <div className="tracklist">
                                            <TrackListScrolling   
                                                ...
                                                addToPlaylist={this.props.playerInstance ? this.props.playerInstance.addTrack : null}
                                                checkPlayerInstance={this.props.checkPlayerInstance}
                                                library={this.props.library}
                                                cover={this.props.LMS.albumArtwork(this.state.album.artwork_track_id)}
                                                LMS={this.props.LMS}
                                            />
