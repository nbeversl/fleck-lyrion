...
class BrowserPlayer {
    ...
    constructor(LMS) {
        ...
        this.playAlbumFromTrackAndContinue = (track, startNumber) => { 
            ...
            this.LMS.request(["",["titles", "0", "100", "album_id:"+albumID, "sort:tracknum", "tags:**e**"]], (r) => {
                ...
                this.playerInstance = new Howl({
                    src: [ this.LMS.getTrack(this.tracks[this.currentIndex].id.toString())] ,
                    onend: () => { 
                       this.nextTrack();          
                    },
                    onload: () => {
