class LMSLibrary {
    ...
    establishLibrary(callback) {
        ...
        this.LMS.request(["",["genres", "0", "1000"]], (r) => {
            r.result.genres_loop.forEach( (item) => {
                ...
                this.LMS.request(["" ,["albums", "0","1000","genre_id:"+ item.id.toString(),"tags:ljaS","sort:artflow" ]], 
                    (r) => {
    ...
    getAllTracksForGenre(id) {
        this.LMS.request(["",["titles","0","10000","genre_id:"+id.toString(), "tags:**t****o****l****i****e****m**"]],(r) => {           
    ...
    getAlbumTracks (albumID, callback) {
        ...
        this.LMS.request(["",["titles","0","500","album_id:"+albumID, "sort:tracknum", "tags:**t****o****l****i****e**"]],(r) => {           
    ...
    searchAlbums(searchString, callback) {
        ...
        this.LMS.request(["",["albums","0","100","search:"+searchString, "tags:ljaS"]],(r) => {           
    ...
    searchContributors(searchString, callback) {
        ...
        this.LMS.request(["",["artists","0","100","search:"+searchString]],(r) => {           
    ...
    searchAlbumsByArtist(artist_id, callback) {
        ...
        this.LMS.request(["",["albums","0","100","artist_id:"+artist_id, "tags:idjtla"]],(r) => {           
            callback(r.result.albums_loop);
        });
    ...
    getPlaylists(callback) {
        this.LMS.request(["",["playlists","0","100", "tags:uplaylist"]], (r) => {
